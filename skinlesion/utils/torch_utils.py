...
from skinlesion.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, __version__
from skinlesion.utils.checks import PYTHON_VERSION, check_version
...
def model_info_for_loggers(trainer):
    ...
    if trainer.args.profile:  # profile ONNX and TensorRT times
        from skinlesion.utils.benchmarks import ProfileModels
